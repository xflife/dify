    ...
    >
      <PortalToFollowElemTrigger className={cn(triggerClassName)} onClick={() => setOpen(v => !v)}>
        <div className={cn(
          s.trigger,
          className,
          notSetVar ? 'bg-[#FFFCF5] border-[#FEDF89] text-[#DC6803]' : ' hover:bg-gray-50 border-[#F1F3F9] text-primary-600',
      ...
      <PortalToFollowElemContent style={{ zIndex: 1000 }}>
        {options.length > 0
          ? (<div className='w-[240px] max-h-[50vh] overflow-y-auto p-1  border bg-white border-[#F1F3F9] rounded-lg shadow-lg'>
          ...
          : (
            <div className='w-[240px] p-6 bg-white border border-[#F1F3F9] rounded-lg shadow-lg'>
