...
const Item: FC<ItemProps> = ({
  ...
  return (
    <div className='group flex items-center mb-2 px-4 py-2 border-[0.5px] border-transparent rounded-xl bg-gray-50 hover:border-[#F1F3F9] hover:shadow-xs'>
      <div className='grow'>
      ...
      <div className='hidden group-hover:flex items-center'>
        <div
          className='flex items-center mr-1 px-3 h-7 bg-white text-xs font-medium text-gray-700 rounded-md border-[0.5px] border-[#F1F3F9] shadow-xs cursor-pointer'
        ...
        <div
          className='flex items-center justify-center w-7 h-7 bg-white text-gray-700 rounded-md border-[0.5px] border-[#F1F3F9] shadow-xs cursor-pointer'
